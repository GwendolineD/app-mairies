        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "img-src 'self' https://res.cloudinary.com data: blob: https://*.tile.openstreetmap.org https://*.basemaps.cartocdn.com",
              "font-src 'self'",
              "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api-adresse.data.gouv.fr https://geo.api.gouv.fr https://*.tile.openstreetmap.org https://*.basemaps.cartocdn.com",
