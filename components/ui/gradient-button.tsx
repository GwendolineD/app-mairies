...
const baseClass =
  "inline-flex cursor-pointer items-center justify-center gap-2 rounded-md px-6 py-3 text-sm font-bold text-white shadow-card transition hover:opacity-95 disabled:cursor-not-allowed disabled:opacity-50";
